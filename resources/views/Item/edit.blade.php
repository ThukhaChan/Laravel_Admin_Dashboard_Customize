                    ...
                    <div class="">
                        ...
                        <form method="POST" action="{{ route('item.update',$item->id) }}">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" name="price" class="form-control @error('price')is-invalid @enderror" value="{{ $item->price }}">
                            </div>
                            <div class="mb-3 mt-3">
                                <label  class="form-label">Expired Date</label>
                                <input type="text" name="expired_date" class="form-control @error('expired_date')is-invalid @enderror" value="{{ $item->expired_date }}">
                            </div>
                            <div class="mb-4">
